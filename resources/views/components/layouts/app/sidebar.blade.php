...
<flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
    ...
    <flux:navlist variant="outline">
        <flux:navlist.group :heading="__('Platform')" class="grid">
            ...
            <flux:navlist.item icon="car" :href="route('vehicles.index')"
                               :current="request()->routeIs('vehicles.index')"
                               wire:navigate>{{ __('Vehicles') }}</flux:navlist.item>
            <flux:navlist.item icon="fuel" :href="route('fuel-entries.index')"
                               :current="request()->routeIs('fuel-entries.index')"
                               wire:navigate>{{ __('Fuel Entries') }}</flux:navlist.item>
        </flux:navlist.group>
    </flux:navlist>
